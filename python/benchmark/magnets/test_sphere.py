...
def compute_magba(magnet: SphereMagnet, observers: FloatArray):
    magnet.compute_B(observers)


def compute_magpy(magnet: Sphere, observers: FloatArray):
    magnet.getB(observers)


def test_sphere_magba(benchmark, magba_magnet, observers):
    benchmark(compute_magba, magba_magnet, observers)


def test_sphere_magpy(benchmark, magpy_magnet, observers):
