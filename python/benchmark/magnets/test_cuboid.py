...
def compute_magba(magnet: CuboidMagnet, observers: FloatArray):
    magnet.compute_B(observers)


def compute_magpy(magnet: Cuboid, observers: FloatArray):
    magnet.getB(observers)


def test_cuboid_magba(benchmark, magba_magnet, observers):
    benchmark(compute_magba, magba_magnet, observers)


def test_cuboid_magpy(benchmark, magpy_magnet, observers):
