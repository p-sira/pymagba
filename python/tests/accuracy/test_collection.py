...
from tests.testing_util import get_points_small, load_test_array
...
def test_collection_homogeneous_cylinder():
    c1 = CylinderMagnet(
        position=(0.0094, 0.0, -0.006),
        orientation=Rotation.from_rotvec((1.2092, 1.2092, 1.2092)),
        diameter=3e-3,
        height=4e-3,
        polarization=(1.0, 2.0, 3.0),
    )
    c2 = CylinderMagnet(
        position=(-0.0047, 0.0081, -0.006),
        orientation=Rotation.from_rotvec((1.5316, 0.4104, 0.4104)),
        diameter=4e-3,
        height=5e-3,
        polarization=(0.4, 0.5, 0.6),
    )
    c3 = CylinderMagnet(
        position=(-0.0047, -0.0081, -0.006),
        orientation=Rotation.from_rotvec((1.5316, -0.4104, -0.4104)),
...
def test_collection_homogeneous_cuboid():
    ...
    c1 = CuboidMagnet(
        ...
        orientation=rot1,
        dimensions=(0.02, 0.02, 0.03),
        polarization=(0.1, 0.2, 0.3),
    )
    c2 = CuboidMagnet(
        position=(0.015, 0.005, 0.01),
        orientation=rot2,
        dimensions=(0.02, 0.02, 0.03),
        polarization=(0.1, 0.2, 0.3),
    )
    c3 = CuboidMagnet(
        position=(0.01, 0.015, 0.005),
        orientation=rot3,
        dimensions=(0.02, 0.02, 0.03),
        polarization=(0.1, 0.2, 0.3),
    )
